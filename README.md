...
docker run --gpus all -it --rm --ipc=host -v /tmp:/tmp --name icelandic donchev7/icelandic-model:v83719a0 python src/train_maskedLM.py --data_dir=/tmp --run_name=<SundayRunV1> 
