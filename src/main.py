...
from language_model.IsRoBERTa import IsRoBERTa
from language_model.dataset.oscar import Oscar
...
parser.add_argument("--run_name", type=str, help="Name the model run . Defaults to icelandic-model", default="icelandic-model")
parser.add_argument(
